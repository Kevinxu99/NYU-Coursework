...
def subtree_min_and_max(subtree_root):
    if(subtree_root.left == None and subtree_root.right == None):
        ...
        right_min_max = subtree_min_and_max(subtree_root.right)
        subtree_min = min(subtree_root.data, right_min_max[0])
        subtree_max = max(subtree_root.data, right_min_max[1])
        return (subtree_min, subtree_max)
    elif(subtree_root.right == None):
        left_min_max = subtree_min_and_max(subtree_root.left)
        subtree_min = min(subtree_root.data, left_min_max[0])
        subtree_max = max(subtree_root.data, left_min_max[1])
        return (subtree_min, subtree_max)
    else:
        right_min_max = subtree_min_and_max(subtree_root.right)
        left_min_max = subtree_min_and_max(subtree_root.left)
        subtree_min = min(subtree_root.data, min(right_min_max[0], left_min_max[0]))
        subtree_max = max(subtree_root.data, max(right_min_max[1], left_min_max[1]))
        return (subtree_min, subtree_max)

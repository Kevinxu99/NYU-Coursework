...
def recursive_invert(tree1, tree2):
    if(tree2 is None):
        return None
    tree1 = LinkedBinaryTree.Node(tree2.data)
    tree1.left = recursive_invert(LinkedBinaryTree().root, tree2.right)
    tree1.right = recursive_invert(LinkedBinaryTree().root, tree2.left)
    return tree1

def invert_tree(original_tree):
    new_tree = LinkedBinaryTree()
    return LinkedBinaryTree(recursive_invert(new_tree.root, original_tree.root))


a = LinkedBinaryTree.Node(1)
b = LinkedBinaryTree.Node(3)
c = LinkedBinaryTree.Node(6)
d = LinkedBinaryTree.Node(9)
e = LinkedBinaryTree.Node(2,a,b)
f = LinkedBinaryTree.Node(7,c,d)
g = LinkedBinaryTree.Node(4,e,f)
tree1 = LinkedBinaryTree(g)
tree2 = invert_tree(tree1)
for curr in tree2.inorder():
    print(curr.data,end="")
